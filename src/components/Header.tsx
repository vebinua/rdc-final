      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8" aria-label="Main navigation">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            >
              Home
              <span aria-hidden="true" className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-[#5680E9] to-[#84CEEB] group-hover:w-full transition-all duration-300"></span>
            </Link>
            ...
            >
              <button
                ...
                onKeyDown={(e) => {
                  if (e.key === 'ArrowDown') {
                    ...
                    const firstItem = servicesDropdownRef.current?.querySelector<HTMLElement>('a, button');
                    firstItem?.focus();
                  }
                }}
              ...
              >
                ...
                <span aria-hidden="true" className={`absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-[#5680E9] to-[#84CEEB] transition-all duration-300 ${isServicesOpen ? 'w-full' : 'group-hover:w-full'}`}></span>
              </button>
                ...
                <div className="w-80 bg-white rounded-xl shadow-xl border border-gray-200 p-2">
                  ...
                  >
                    <button
                      ...
                      aria-controls="other-services-submenu"
                      ...
                      className="flex items-center justify-between w-full px-4 py-3 text-gray-700 hover:bg-blue-50 rounded-lg transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5680E9]"
                    >
                      <div className="flex items-center space-x-3">
                        <div aria-hidden="true" className="w-8 h-8 bg-gradient-to-br from-[#C1C8E4] to-[#5680E9] rounded-lg flex items-center justify-center flex-shrink-0">
                          <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      ...
                      <svg aria-hidden="true" className={`w-4 h-4 transition-transform duration-200 ${isOtherServicesOpen ? 'rotate-180' : 'rotate-90'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              to="/contact"
              className={`group/cta relative px-6 py-2.5 rounded-full font-bold transition-all duration-300 transform hover:scale-105 overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#84CEEB] focus-visible:ring-offset-2 ${
                isScrolled
            ...
            >
              <span className="relative z-10 flex items-center gap-2">
                Contact
                <svg aria-hidden="true" className="w-4 h-4 group-hover/cta:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
              </span>
              {isScrolled && (
                <div aria-hidden="true" className="absolute inset-0 bg-gradient-to-r from-[#4c6fd4] to-[#7c3aed] opacity-0 group-hover/cta:opacity-100 transition-opacity duration-300"></div>
              )}
            </Link>
          </div>
          ...
          <button
            ...
            className={`lg:hidden p-2 rounded-lg transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#84CEEB] focus-visible:ring-offset-2 ${
              isScrolled
        ...
        >
          <div className="py-4 space-y-2 bg-white/95 backdrop-blur-sm rounded-xl mt-4 shadow-xl border border-gray-200">
            ...
            <div className="px-4 py-2">
              <Link
                to="/contact"
                className="block w-full text-center px-6 py-3 bg-gradient-to-r from-[#5680E9] to-[#8860D0] text-white rounded-full font-medium transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#84CEEB] focus-visible:ring-offset-2"
                onClick={closeMenu}
              >
                Contact
              </Link>
